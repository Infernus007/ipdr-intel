    ...
    items: [
      {
        href: "/records",
        label: "Records",
        description: "View and analyze IPDR records.",
      },
      {
        href: "/analytics",
        label: "Analytics",
...
export default function Component() {
  const walkthroughTarget = useWalkthroughTarget('nav-menu');
  
  return (
    <header className="border-b px-4 md:px-6" {...walkthroughTarget}>
